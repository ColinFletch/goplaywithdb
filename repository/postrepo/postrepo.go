...
import (
	...
	pRepo "github.com/colinfletch/goplaywithdb/repository"
)
...
func (m *mysqlPostRepo) ViewAllPosts(ctx context.Context, num int64) ([]*models.Post, error) {
	query := "Select id, title, content From posts limit ?"

	return m.fetch(ctx, query, num)
}

func (m *mysqlPostRepo) ViewPost(ctx context.Context, id int64) (*models.Post, error) {
...
func (m *mysqlPostRepo) CreatePost(ctx context.Context, p *models.Post) (int64, error) {
...
func (m *mysqlPostRepo) UpdatePost(ctx context.Context, p *models.Post) (*models.Post, error) {
...
func (m *mysqlPostRepo) DeletePost(ctx context.Context, id int64) (bool, error) {
